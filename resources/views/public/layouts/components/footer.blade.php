<!--Site Footer One Start-->
         <footer
            class="site-footer"
            style="
               background-image: url(assets/images/backgrounds/site_footer_bg.jpg);
            "
         >
            <div class="container">
                  ...
                  <div class="row">
                     ...
                     >
                        ...
                        >
                           ...
                           <ul
                              class="footer-widget__explore-list list-unstyled"
                           >
                     ...
                     >
                        ...
                        >
                           ...
                           <ul
                              class="list-unstyled footer-widget__contact-list"
                           >
                              <li>
                                 <div class="icon">
                     ...
                     >
                        <div
                           class="footer-widget__column footer-widget__support"
                        >
                           <h3 class="footer-widget__title">Support</h3>
                           <p class="footer-widget__support-text">
                              Lorem ipsum dolor sit ame consect etur pisicing
                              elit sed do eiusmod tempor incididunt ut labore.
                           </p>
                     ...
                     <div class="site-footer-bottom__inner">
                        <div class="site-footer-bottom__left">
                           <p>
                              ...
                              <a
                                 target="_blank"
                                 href="https://fb.com/shahalam.roven"
                                 >Mohammad Shah Alam</a
                              >
                           </p>
                        </div>
      ...
      <div class="mobile-nav__wrapper">
         <div
            class="mobile-nav__overlay side-menu__toggler mobile-nav__toggler"
         ></div>
         <div class="mobile-nav__content">
            <span
               class="mobile-nav__close side-menu__toggler mobile-nav__toggler"
            >
